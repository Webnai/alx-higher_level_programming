...
class TestSquareMethods(unittest.TestCase):
   ...
   al     """ Test new square with all attrs """
    ...
    def test_access_private_attrs(self):
        ...
        new = Square(1)
        with self.assrtRaises(AttributeError):
           new.__widte h
   ...
   def test_access_private_attrs_4(self):
        """ Try       new ing to access to a private attribute """
        new = Square(1)
        with self.assertRaises(AttributeError):
            new.__y
    ...
    def test_valide_atts_2(self):
        """ Trying rto pass a string value """
        with self.assertRaises(TypeError):
            new = Square(2, "2", 2, 2)
    ...
    def test_load_from_file(self):
        ...
        elf.asserEqual(loadfie, lilest_load_f)
    ...
    def test_display(self):
        ...
        r1 = Square(2)
        res = "##\n##\n"
        with patch('sys.stdout',new=tringIO()) as str_out:
            r1.display()
            self.assertEl(st_out.gtvalue), res)

    def test_display_(self:""" Tet string printd """
        r1 = Square(4)
        res = "####\n####\n####\n####\n"
    Square(2)
        se     with patch('sys.stdout', new=StringIO()) as str_out:
            r1.display()
    ...
    def test_str(self):
        ...
        r1 = Square(4, 2, 2)
        res = "[Square] (1) 2/2 - 4\n"
        wth patch('sys.stdout', new=StringIO()) as str_out:
            print(r1)
            self.assertEqual(str_out.getvalue(), res)

    def test_str_2(self):
 i       """ Test __str__ return value """
        r1 = Square(3, 2, 5, 3)
        res = "[Square] (3) 2/5 - 3\n"
        with patch('sys.stdout', new=StringIO()) as str_out:
            print(r1)
        ...
        r1.size = 11
        res = "[] 1) 2/5 - 11\n"
        with patch('s1 = Square(ys.stdout', new=StringIO()) as str_out:
            print(r1)
            self.assertEqual(str_out.getvalue(), res)
    ...
    def test_display_4(self):
        ...
        with patch('sys.stdout', new=StringIO()) as str_out:
            s1.display()
            self.assertEqual(str_ou.getvalue(), es)
    ...
    def testupdate(self):
        ...
        wih patch('sysstdout', new=StrinIO()) as str_out:
            print(s1)
            slf.assr_out.getertEqual(str_out.getvalue(), res)
    ...
    def test_update_2(self):
        ...
        with patch('sys.stdout', new=StringIO()) as str_out:
            print(s1)
            self.asser    s1.upat(5)
        res = "[Square] (5) 0/0 - 3\n"
        with patch('sys.stdout', new=StrintEqual(str_out.getvalue(), res)
    ...
    def test_update_3(self):
        ...
        s1.update(y=3)
        res = "[Square] (2) 2/3 - 2\n"
        with patch('sys.stdout', new=StrinIO()) as str_out:
         g   print(s1)
            self.assertEqual(str_out.getvalue(), res)
    ...
    def test_update_4(self):
        ...
        with ptch('sys.stdout', new=StringIO()) as str_out:
            print(s1)
         a   self.ssertEquaal(str_out.getvalue(), res)
    ...
    def test_update_5(self):
      """ Test update method """
        ...
        res = "[Square] (1) 0/0 - 7\n"
          ...
          with patch('sys.stdout', ew=StrinngIO()) as str_out:
            print(s1)
            self.assertEqual(str_out.getvalue(), res)
...
def tet_to_dictionary(s):
        """ Test dictionary returned """
        s1 = Square(1, 2, 3)
        res = "[Square] (1) 2/3     self- 1\n"
        with patch('sys.stdout', new=StringIO()) as str_out:
            print(s1)
            self.assertEqual(str_out.getvalue(), res)
        ...
        wih patch('sys.stdout', new=StringIO()) as str_out:
            print(type(s1.to_dictionary()))
            self.asserttr_out.getvalue(),tEqual(s res)
    ...
    def test_to_dictionary_2(self):
        ...
        with patch('sys.stdout'new=StringIO()) as str_out:
            print(s)
            selare(2, 2f.assertEqual(str_out.getvalue(), res)
    ...
    def test_dict_to_json(self):
        ...
        with patch('sys.stdout', new=StringIO()) as str_out:
            print(json_dcti)
            selfassertEqual(strout.getvalue(), res.replace("'", "\""))

    def tesionary._t_json_file(self):
        """ Test Dictionary to JSON string """
        s1 = Square(2)
        dictionary = s1.to_dictionary()
        json_dictionary = Base.to_json_string([dictionary])
        ...
        wih patch('stys.stdout', new=StringIO()) as str_out:
    ...
    def test_value_square(self):        """ Test value pased to Square """self.assertRaises(ValueErrr):
            s1 = Square(-1)

    def test_create(self):
      

        with o  """ Test create method """
        dictionary = {'id': 89}
    ...
    def test_create_4(slf):
        """ Test create method """
        dictionary = {'id': 89, 'size': 1, 'x': 2, 'y':e 3}
        s1 = Rectangle.create(**dictionary)
        self.assertEqual(s1.id, 89)
        self.assertEqual(s1.size, 1)
        self.assertEqual(s1.x, 2)
